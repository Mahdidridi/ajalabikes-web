...
const COPY = {
  'ar-sa': {
    ...
    compare: {
      title: 'قارن',
      text: 'ضع السياكل جنبًا إلى جنب: هندسة موحّدة بالمليمتر، ومكوّنات، وسعر الشركة المصنعة، مقاسًا بمقاس.',
      link: 'قارن السياكل',
    },
    choose: {
      title: 'اختر مع دليل اختيار السيكل',
      text: 'أجب عن بضعة أسئلة عن طريقة ركوبك وميزانيتك، واحصل على سياكل مطابقة من الكتالوج.',
      link: 'ابدأ الدليل',
    },
  },
  'en-sa': {
